...
func TestFilteredPages(t *testing.T) {
	...
	for _, tt := range []struct {
		...
		{path: "/api/client-keys?q", ids: []string{"a", "b", "z"}, total: 3, limit: 50},
		{path: "/api/client-keys?q&limit=50", ids: []string{"a", "b", "z"}, total: 3, limit: 50},
		{path: "/api/client-keys?limit=50&q", ids: []string{"a", "b", "z"}, total: 3, limit: 50},
		{path: "/api/client-keys?q=true", ids: []string{}, total: 0, limit: 50},
